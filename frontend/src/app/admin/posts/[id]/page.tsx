...
export default function EditPostPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const response = await adminUpdatePost(postId, {
      title: title.trim(),
    ...
    if (response.success) {
      ...
      addToast('error', response.error || 'Failed to update post');
    }
  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-8">
        ...
        <p className="text-text-secondary">Update this post&apos;s content and settings.</p>
      </div>
